...
<div class="notification-details-container">
    ...
    <div class="notification-details-card">
        <div class="notification-details">
            <h5 class="card-title"><?php echo $notificationDetails['name']; ?></h5>
            <p class="card-text"><?php echo $notificationDetails['details']; ?></p>
            <p class="card-text"><strong>Date:</strong> <?php echo $notificationDetails['date']; ?></p>
        </div>
    </div>

    <!-- Back to Manage Notifications button -->
    <a href="manage-notifications.php" class="btn btn-primary back-button">Back to Manage Notifications</a>
</div>
</main>
    </div>
