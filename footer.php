...
<!-- Footer section with accent background -->
<footer class="footer accent">
    <!-- Main container for the footer -->
    <div class="container">
        <!-- Main flex container for the footer content -->
        <div class="footer_main d-sm-flex flex-wrap flex-lg-nowrap justify-content-between">
            ...
            <div class="footer_main-block footer_main-block--about col-sm-7 col-lg-auto d-flex flex-column">
                <!-- Brand logo and name in the footer -->
            ...
            <div class="footer_main-block footer_main-block--nav col-sm-6 col-lg-auto">
                ...
                <ul class="footer_main-block_nav d-flex flex-lg-column">
                    ...
                    <li class="list-item">
                        <a class="link   nav-item" data-page="home" href="index.php">Home</a>
                    </li>
                    <!-- About link with dynamic class for active page -->
                    <li class="list-item">
                        <a class="link   nav-item" data-page="about" href="About.php">About</a>
                    </li>
                    <!-- Hostel link with dynamic class for active page -->
                    <li class="list-item">
                        <a class="link   nav-item" data-page="rooms" href="room.php">Hostel</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="footer_main-block footer_main-block--contacts col-sm-5 col-lg-auto">
                ...
                <ul class="footer_main-block_contacts">
                    ...
                    <li class="list-item d-flex">
                        ...
                        <!-- Paragraph with address information -->
                        <p class="wrapper">
                            <span class="linebreak"> Digby Stuart </span>
                            <span class="linebreak"> College </span>
                        </p>
                    </li>
                    ...
                    <li class="list-item d-flex">
                        ...
                        <!-- Paragraph with phone numbers -->
                        <p class="wrapper d-flex flex-column">
                            <a class="link" href="tel:+1234567890">(44) 123-5467</a>
                            <a class="link" href="tel:+1234567890">(44) 245-9087</a>
                        </p>
                    </li>
                </ul>
            </div>

            <!-- Follow Us section in the footer -->
            <div class="footer_main-block footer_main-block--follow col-sm-5 col-lg-auto d-flex flex-column">
                <!-- Header for the Follow Us section -->
                <h4 class="footer_main-block_header">Follow Us</h4>
                <!-- Paragraph with additional text (if any) -->
                <p class="footer_main-block_text"></p>
