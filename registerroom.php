...
<body>
    ...
    <form id="registrationForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
        ...
        <br>
        <label for="termsAndConditionsCheck">
            <input type="checkbox" id="termsAndConditionsCheck" name="termsAndConditionsCheck" required>
            I agree to the <a href="termsandcondition.php" target="_blank">Terms and Conditions</a>
        </label>
        <br>

        <input type="submit" value="Submit" class="btn theme-element--accent">
    </form>
